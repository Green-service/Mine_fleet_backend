              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:16px 0;background:#f7f8fb;border:1px solid #eef0f5;border-radius:10px;">
                <tr>
                  <td style="padding:14px 16px;">
                    <p style="margin:0 0 6px;font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#6d7484;">Work email</p>
                    <p style="margin:0 0 12px;font-size:14px;color:#151820;">${safe(email)}</p>
                    <p style="margin:0 0 6px;font-size:11px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#6d7484;">Temporary password</p>
                    <p style="margin:0;font-size:16px;font-weight:700;font-family:monospace;color:#151820;">${safe(password)}</p>
                  </td>
                </tr>
              </table>
              <p style="margin:0 0 8px;font-size:13px;line-height:1.5;color:#6d7484;">
                Sign in with the details above, then change this password from your profile as soon as you're in.
              </p>
              ${
                loginUrl
